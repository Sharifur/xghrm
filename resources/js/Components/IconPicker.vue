<template>
<div class="icon-picker--wraper--outer">
      <span v-bind="$attrs" @click="togglePicker" class="icon-picker--wraper">
        <i class="vue3-icon-picker" :class="modelValue">Select icon</i>
          <input type="hidden" :value="modelValue" :name="inputName" @change="$emit('update:modelValue', $event.target.value)">
      </span>
</div>
